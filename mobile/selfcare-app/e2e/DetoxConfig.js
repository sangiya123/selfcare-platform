...
module.exports = {
  ...
  ios: {
    debug: {
      ...
      app: 'ios/build/Build/Products/Debug-iphonesimulator/OmobioSelfcare.app',
      bundleId: 'com.omobio.selfcare',
      language: 'en',
      locale: 'US',
    },
    release: {
      ...
      app: 'ios/build/Build/Products/Release-iphoneos/OmobioSelfcare.app',
      bundleId: 'com.omobio.selfcare',
      language: 'en',
      locale: 'US',
    },
  ...
  android: {
    debug: {
      ...
      device: {
        ...
        avdName: process.env.AVD_NAME || 'Omobio_API_34',
      },
      app: 'android/app/build/outputs/apk/debug/app-debug.apk',
      package: 'com.omobio.selfcare',
      language: 'en',
      locale: 'US',
    },
    release: {
