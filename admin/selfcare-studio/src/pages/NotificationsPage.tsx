...
const MOCK_NOTIFICATIONS: Notification[] = [
  { id: '1', title: 'Data Pack Expiry Reminder', body: 'Your 10GB data pack expires in 24 hours. Top up now to stay connected.', sentAt: '2025-08-28 09:00', status: 'sent', reach: 45230, clickRate: 12.4, channel: 'push', priority: 'high', audience: 'All users', deepLink: 'omobio://data/topup' },
  ...
  { id: '3', title: 'Bill Payment Due', body: 'Your bill payment of LKR 1,250 is due on 5th. Pay now to avoid late fees.', sentAt: '2025-08-25 08:00', status: 'sent', reach: 12500, clickRate: 8.2, channel: 'sms', priority: 'high', audience: 'Postpaid users', deepLink: 'omobio://billing/pay' },
...
const MOCK_CAMPAIGNS: Campaign[] = [
  { id: '1', title: 'Summer Data Bonanza', description: 'Get extra 5GB on every data pack purchase this summer', bannerUrl: 'https://picsum.photos/seed/summer/800/300', targetUrl: 'omobio://offers/summer', startDate: '2025-06-01', endDate: '2025-08-31', status: 'active', audience: 'All users', impressions: 125000, clicks: 8500, displayCondition: 'App launch' },
  { id: '2', title: 'New App Features Tour', description: 'Discover the new features in our latest app update', bannerUrl: 'https://picsum.photos/seed/features/800/300', targetUrl: 'omobio://onboarding/features', startDate: '2025-08-15', endDate: '2025-09-30', status: 'active', audience: 'App version < 3.0', impressions: 45000, clicks: 3200, displayCondition: 'After login' },
  { id: '3', title: 'Loyalty Rewards Week', description: 'Double points on all transactions for loyalty members', bannerUrl: 'https://picsum.photos/seed/loyalty/800/300', targetUrl: 'omobio://rewards', startDate: '2025-09-01', endDate: '2025-09-07', status: 'scheduled', audience: 'Gold members', impressions: 0, clicks: 0, displayCondition: 'First launch of week' },
  { id: '4', title: 'Back to School Offer', description: 'Special data packs for students at 30% discount', bannerUrl: 'https://picsum.photos/seed/school/800/300', targetUrl: 'omobio://offers/student', startDate: '2025-07-15', endDate: '2025-09-15', status: 'inactive', audience: 'Age 18-25', impressions: 89000, clicks: 5600, displayCondition: 'App launch' },
];
          ...
          <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="omobio://offers/summer"
              />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
