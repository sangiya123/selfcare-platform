...
export default function LoginPage() {
  ...
  const onSubmitCredentials = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Real call would hit /api/v1/admin/auth/login
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-blue-50 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">OMOBIO Studio</h1>
        ...
        <p className="text-xs text-center text-gray-400 mt-4">
          Protected by OMOBIO admin identity. All access is logged.
        </p>
      </div>
    </div>
  );
