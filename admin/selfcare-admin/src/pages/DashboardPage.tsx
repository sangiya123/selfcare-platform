...
export default function DashboardPage() {
  ...
  const systemHealth = tenantsError ? 'degraded' : 'healthy';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <KpiCard
          ...
          value={tenantsLoading ? undefined : tenants.length.toLocaleString()}
        ...
        <KpiCard
          ...
          value={auditLoading ? undefined : auditEvents.length.toLocaleString()}
          icon={<Activity className="w-4 h-4 text-gray-400" />}
          subtitle="Latest from audit log"
          loading={auditLoading}
        />
        <KpiCard
          title="Pending Approvals"
          value={approvalsLoading ? undefined : pendingApprovals.length.toLocaleString()}
          icon={<CheckCircle className="w-4 h-4 text-gray-400" />}
          subtitle="Four-eyes workflow queue"
        ...
        <KpiCard
          ...
          subtitle={tenantsLoading ? 'Checking...' : systemHealth === 'healthy' ? 'Admin API reachable' : 'API error detected'}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <KpiCard
          ...
          icon={<TrendingUp className="w-4 h-4 text-gray-400" />}
          subtitle={activeTenantId ? `Tenant ${activeTenantId}` : 'No client selected'}
