...
/**
 * Tenants / Clients — manage the businesses using the selfcare platform.
 *
 * Each tenant has:
...
const DEMO_ENVIRONMENTS: Environment[] = [
  {
    ...
    region: 'ap-south-1',
    apiBaseUrl: 'https://api-dev.dialog.selfcare.local',
    configServiceUrl: 'https://config-dev.dialog.selfcare.local',
  ...
  },
  {
    ...
    region: 'ap-south-1',
    apiBaseUrl: 'https://api-stg.dialog.selfcare.local',
    configServiceUrl: 'https://config-stg.dialog.selfcare.local',
  ...
  },
  {
    ...
    region: 'ap-south-1',
    apiBaseUrl: 'https://api-reg.dialog.selfcare.local',
    configServiceUrl: 'https://config-reg.dialog.selfcare.local',
  ...
  },
  {
    ...
    region: 'ap-south-1',
    apiBaseUrl: 'https://api.dialog.selfcare.com',
    configServiceUrl: 'https://config.dialog.selfcare.com',
...
const DEMO_FEATURES: TenantFeatureEntitlement[] = [
  ...
  { key: 'support.chat',       label: 'In-App Live Chat',         enabled: true,  description: 'selfcare support chat widget.' },
...
export default function TenantsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Demo data banner — shown only when the API is unavailable */}
      {isUsingDemo && (
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-start gap-3">
          <AlertTriangle className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5" />
          <div>
            <p className="font-medium text-amber-800">Demo data — API unreachable</p>
            <p className="text-sm text-amber-700 mt-0.5">
              Showing built-in example tenants. This data will be replaced with live
              data once <code className="bg-amber-100 px-1 rounded">api.tenants.list()</code>{' '}
              returns a result. Configure the backend services to connect to MongoDB.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Businesses using the selfcare platform across industries and countries.
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Onboard a new business onto the selfcare platform. Calls{' '}
