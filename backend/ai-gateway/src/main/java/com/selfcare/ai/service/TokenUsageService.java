...
public class TokenUsageService {
    ...
    private static final String RATE_LIMIT_PREFIX = "selfcare:ai:ratelimit:";
    private static final String USAGE_PREFIX = "selfcare:ai:usage:";
    ...
    public void recordRateLimitViolation(String tenantId, String userId, String limitType) {
        String key = "selfcare:ai:ratelimit:violations:" + LocalDate.now() + ":" + tenantId;
