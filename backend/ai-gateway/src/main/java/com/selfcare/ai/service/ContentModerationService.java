...
public class ContentModerationService {
    ...
    @Value("${selfcare.ai.moderation.openai-api-key:}")
    private String openAiApiKey;

    @Value("${selfcare.ai.moderation.base-url:https://api.openai.com}")
    private String defaultBaseUrl;

    @Value("${selfcare.ai.moderation.enabled:true}")
    ...
    public ModerationResult moderateInput(String message, String tenantId, String userId) {
        ...
        if (openAiApiKey != null && !openAiApiKey.isBlank()) {
            try {
                ModerationResult apiResult = checkWithOpenAiModeration(message, tenantId);
                if (!apiResult.isSafe()) {
    ...
    private ModerationResult checkWithOpenAiModeration(String text, String tenantId) throws Exception {
        String baseUrl = resolveBaseUrl(tenantId);
    ...
    private String resolveBaseUrl(String tenantId) {
        String base = tenantConfig.getBaseUrl(tenantId, "OPENAI");
