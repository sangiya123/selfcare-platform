...
public class VectorEmbeddingService {
    ...
    private static final String EMBEDDING_CACHE_PREFIX = "omobio:embedding:";
    private static final String CHUNKS_KEY_PREFIX = "omobio:chunks:";
    private static final int EMBEDDING_DIM = 1536; // text-embedding-3-small
    private static final Duration CACHE_TTL = Duration.ofHours(24);

    @Value("${omobio.ai.embedding.openai-api-key:}")
    private String openAiApiKey;

    @Value("${omobio.ai.embedding.model:text-embedding-3-small}")
    private String embeddingModel;

    @Value("${omobio.ai.embedding.base-url:}")
    private String customBaseUrl;

    @Value("${omobio.ai.embedding.enabled:false}")
