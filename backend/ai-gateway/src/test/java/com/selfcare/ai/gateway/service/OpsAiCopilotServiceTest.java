...
import com.selfcare.ai.service.OpsAiCopilotService;
import com.selfcare.ai.service.OpsAiCopilotService.Alert;
import com.selfcare.ai.service.OpsAiCopilotService.CapacityForecast;
import com.selfcare.ai.service.OpsAiCopilotService.DeduplicatedAlert;
import com.selfcare.ai.service.OpsAiCopilotService.IncidentInput;
import com.selfcare.ai.service.OpsAiCopilotService.IncidentSummary;
import com.selfcare.ai.service.OpsAiCopilotService.LogEntry;
import com.selfcare.ai.service.OpsAiCopilotService.Metric;
...
class OpsAiCopilotServiceTest {
    ...
    void correlate_config() {
        ...
        OpsAiCopilotService.ConfigChangeEvent event = new OpsAiCopilotService.ConfigChangeEvent(
                "dialog-lk", "LAYOUT_PUBLISH", "layout:home", "5", "admin@selfcare", configTime);
        OpsAiCopilotService.CorrelationResult r = service.correlateConfigAndReleases(
    ...
    void correlate_picks_higher() {
        Instant incidentStart = Instant.parse("2026-09-03T12:00:00Z");
        Instant releaseTime = incidentStart.minusSeconds(30); // 0 min before, higher confidence
        ...
        // Release (0 min before, higher confidence) wins over config (1 min before, lower confidence)
