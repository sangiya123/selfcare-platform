...
import com.selfcare.ai.service.AiGovernanceService;
...
class AiGovernanceServiceTest {
    ...
    @Mock private AiPromptVersionRepository promptVersionRepository;
    ...
    @BeforeEach
    void setUp() {
        service = new AiGovernanceService(useCaseRepository, killSwitchRepository,
                promptVersionRepository, tokenUsageService);
