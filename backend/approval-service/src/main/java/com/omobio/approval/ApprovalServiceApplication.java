 ...
 *
 * Implements the OMOBIO platform's mandatory review process for the 9
 * high-risk actions defined in {@link com.omobio.approval.domain.ApprovalAction}.
 *
 * Capabilities:
...
@EnableScheduling
@EnableJpaAuditing
@EnableJpaRepositories("com.omobio.approval.repository")
