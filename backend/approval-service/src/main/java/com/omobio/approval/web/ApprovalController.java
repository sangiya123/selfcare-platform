package com.omobio.approval.web;

import com.omobio.approval.domain.ApprovalRequest;
import com.omobio.approval.domain.ApprovalStatus;
import com.omobio.approval.service.ApprovalWorkflowService;
import com.omobio.approval.web.dto.ApprovalDecisionDto;
import com.omobio.approval.web.dto.ApprovalRequestDto;
import com.omobio.approval.web.dto.SubmitApprovalDto;
...
public class ApprovalController {
    ...
    public ResponseEntity<ApiResponse<ApprovalRequestDto>> get(@PathVariable String requestId) {
        ApprovalRequest request = service.getRequest(requestId)
                .orElseThrow(() -> new com.omobio.platform.common.web.NotFoundException(
    ...
    public ResponseEntity<ApiResponse<List<String>>> actions() {
        List<String> names = java.util.Arrays.stream(
                        com.omobio.approval.domain.ApprovalAction.values())
                .map(Enum::name)
                .toList();
    ...
    private static ApprovalStatus parseStatus(String status) {
        ...
        try {
            ...
            throw new com.omobio.platform.common.web.BadRequestException(
