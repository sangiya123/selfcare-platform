package com.selfcare.approval.config;
 ...
 *
 * Properties are read from {@code selfcare.approval.*} in application.yml.
 */
@Data
@Configuration
@ConfigurationProperties(prefix = "selfcare.approval")
