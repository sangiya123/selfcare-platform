...
public class DashboardClient {
    ...
    /**
     * Get active packages from product-service.
     */
    public Mono<Object> getActivePackages(String connectionId) {
        return buildClient()
                .get()
                .uri(uriBuilder -> uriBuilder
                        .scheme("http")
                ...
                .bodyToMono(Object.class)
                .timeout(Duration.ofMillis(timeoutMs))
                .doOnError(e -> log.warn("product-service active packages failed: connectionId={}, error={}",
                        connectionId, e.getMessage()));
    }

    /**
     * Get package offers (browse catalog, eligibility-aware) from product-service.
     */
    public Mono<Object> getPackagesByLob(String lob, String connectionId) {
        return buildClient()
                .get()
                .uri(uriBuilder -> uriBuilder
                        .scheme("http")
                ...
                .bodyToMono(Object.class)
                .timeout(Duration.ofMillis(timeoutMs))
                .doOnError(e -> log.warn("product-service packages failed: lob={}, connectionId={}, error={}",
                        lob, connectionId, e.getMessage()));
    }
