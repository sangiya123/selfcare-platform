package com.omobio.dashboard.web;

import com.omobio.dashboard.service.DashboardOrchestratorService;
                ...
                .onErrorResume(e -> {
                    ...
                    return Mono.just(ResponseEntity.internalServerError()
                            .body(ApiResponse.<DashboardResponse>builder()
                                    .data(null)
                                    .meta(com.omobio.platform.common.web.ResponseMeta.builder().build())
                                    .build()));
                });
    }
