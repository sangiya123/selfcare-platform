...
import com.omobio.config.compiler.ConfigCompiler;
import com.omobio.config.domain.LayoutDocument;
import com.omobio.config.domain.ThemeDocument;
import com.omobio.config.repository.LayoutDocumentRepository;
...
public class LayoutService {
    ...
    private static final String MANIFEST_CACHE_PREFIX = "omobio:layout:manifest:";
    ...
    public ConfigCompiler.CompiledManifest getPublishedManifest(
        ...
        LayoutDocument doc = layoutRepository
                ...
                .orElseThrow(() -> new NotFoundException("Layout",
                        tenantId + "/" + experience + "/" + profileKey));
