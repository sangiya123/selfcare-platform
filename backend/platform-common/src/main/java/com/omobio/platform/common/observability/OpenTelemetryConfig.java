 ...
 *
 * Configuration:
 *   omobio.otel.endpoint=http://otel-collector:4317
 *   omobio.otel.service.name=api-gateway
 *   omobio.otel.enabled=true
 */
@Slf4j
@Configuration
public class OpenTelemetryConfig {
    ...
    @Value("${omobio.otel.endpoint:http://localhost:4317}")
    private String otlpEndpoint;

    @Value("${omobio.otel.service.name:unknown-service}")
    private String serviceName;

    @Value("${omobio.otel.enabled:true}")
