 ...
 *
 * The config is loaded by {@link com.selfcare.platform.common.tenant.TenantConfigurationService}
 ...
 *
 * Terminology:
 * - "tenant" / "client" = the business using the selfcare platform
...
public class ClientIntegrationConfig {
    ...
    /** Provider class to load, e.g. "com.selfcare.dialog.provider.DialogAuthProvider" */
