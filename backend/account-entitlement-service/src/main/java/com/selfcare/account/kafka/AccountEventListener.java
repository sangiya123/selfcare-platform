package com.selfcare.account.kafka;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.selfcare.account.service.AccountService;
import com.selfcare.account.service.EntitlementService;
...
public class AccountEventListener {
     ...
     */
    @KafkaListener(
            topics = "${selfcare.kafka.topics.account-profile-updated:account.profile.updated}",
     ...
     */
    @KafkaListener(
            topics = "${selfcare.kafka.topics.account-connection-changed:account.connection.changed}",
            groupId = "${spring.kafka.consumer.group-id:account-entitlement-service}"
    )
