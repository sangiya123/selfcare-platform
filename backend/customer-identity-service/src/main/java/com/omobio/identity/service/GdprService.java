...
import com.omobio.identity.domain.ConsentRecord;
import com.omobio.identity.domain.DataErasureRequest;
import com.omobio.identity.repository.ConsentRecordRepository;
import com.omobio.identity.repository.DataErasureRequestRepository;
...
public class GdprService {
    ...
    @Value("${omobio.gdpr.kafka.topic.user-erasure:identity.user.erasure}")
