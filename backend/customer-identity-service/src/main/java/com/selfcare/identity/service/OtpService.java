...
import com.selfcare.identity.domain.OtpCode;
import com.selfcare.identity.repository.OtpRepository;
...
public class OtpService {
    ...
    @Value("${selfcare.security.otp.ttl-seconds:300}")
    private int otpTtlSeconds;

    @Value("${selfcare.security.otp.max-attempts:5}")
    private int maxAttempts;

    @Value("${selfcare.security.otp.lockout-seconds:1800}")
    private int lockoutSeconds;

    @Value("${selfcare.security.otp.code-length:6}")
    private int codeLength;

    @Value("${selfcare.notification.service.url:http://notification-service:8090}")
    private String notificationServiceUrl;

    private static final String LOCKOUT_KEY_PREFIX = "selfcare:otp:lockout:";
