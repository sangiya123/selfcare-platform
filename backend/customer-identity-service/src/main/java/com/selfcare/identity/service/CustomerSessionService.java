...
public class CustomerSessionService {
    ...
    @Value("${selfcare.security.session.refresh-ttl-seconds:2592000}") // 30 days default
    private long refreshTtlSeconds;

    @Value("${selfcare.security.session.inactivity-timeout-seconds:1800}") // 30 min default
    private long inactivityTimeoutSeconds;

    private static final String SESSION_CACHE_PREFIX = "selfcare:session:";
