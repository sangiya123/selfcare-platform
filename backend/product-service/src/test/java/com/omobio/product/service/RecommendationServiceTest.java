...
import com.omobio.product.repository.OfferRepository;
...
class RecommendationServiceTest {
    ...
    void recommend_boostsUsageMatch() {
        ...
        Product p1 = product("p-1", "DATA");
        Product p2 = product("p-2", "VOICE");
    ...
    void activeOffersForProduct() {
        ...
        when(offerRepository.findActiveOffersForProduct("t1", "p-1", any()))
