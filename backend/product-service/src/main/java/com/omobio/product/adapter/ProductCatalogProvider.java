package com.omobio.product.adapter;
 ...
 *
 * Each operator implements this to expose their catalog in canonical form.
 * ProductService aggregates, dedups, and materializes into the read model.
 */
