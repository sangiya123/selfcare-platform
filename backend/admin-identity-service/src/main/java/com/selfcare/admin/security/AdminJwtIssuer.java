...
public class AdminJwtIssuer {
    ...
    @Value("${selfcare.security.admin-jwt.issuer:selfcare-admin-identity}")
    private String issuer;

    @Value("${selfcare.security.admin-jwt.audience:selfcare-platform}")
    private String audience;

    @Value("${selfcare.security.admin-jwt.access-token-seconds:3600}")
    private long accessTokenSeconds;

    @Value("${selfcare.security.admin-jwt.refresh-token-seconds:2592000}")
    ...
    /**
     * Get the RSA public key (used for JWKS publication).
     */
