...
public class AdminSessionService {
    ...
    @Value("${selfcare.security.session.refresh-ttl-seconds:2592000}")
    private long refreshTtlSeconds;

    @Value("${selfcare.security.session.inactivity-timeout-seconds:1800}")
    private long inactivityTimeoutSeconds;

    private static final String SESSION_CACHE_PREFIX = "selfcare:admin:session:";
