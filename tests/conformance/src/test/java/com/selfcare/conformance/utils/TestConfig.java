...
public final class TestConfig {
    ...
    public static final String BASE_URL = System.getProperty("selfcare.base-url", "http://localhost:8080");
    public static final String DEFAULT_TENANT = System.getProperty("selfcare.tenant", "dialog-lk");
    public static final String ADMIN_TENANT = System.getProperty("selfcare.admin-tenant", "aia-lk");
