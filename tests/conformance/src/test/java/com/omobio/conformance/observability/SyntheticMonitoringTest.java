package com.omobio.conformance.observability;
...
public class SyntheticMonitoringTest {
    ...
    public void setup() {
        ...
        baseUrl = System.getProperty("test.api.gateway", "http://api.stg.omobio.io");
        tenantId = System.getProperty("test.tenant", "dialog-lk");

        RestAssured.enableLoggingOfRequestAndResponseIfValidationFails();

        // Obtain a valid token (test user, not a real customer)
        String username = System.getProperty("test.admin.user", "synthetic-test@omobio.io");
