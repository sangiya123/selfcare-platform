...
public class AIAHttpClient {
    ...
    /**
     * Live SSRF enforcement: every outbound request to an AIA endpoint is
    ...
    private void enforceAllowlist(String baseUrl) {
        ...
        try {
            ...
            log.warn("AIA outbound request blocked by SSRF allow list: {}", baseUrl);
            throw new AIAApiException(null, AIAApiException.AIA_SEC_001,
