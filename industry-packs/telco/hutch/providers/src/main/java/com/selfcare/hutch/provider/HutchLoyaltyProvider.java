...
import com.selfcare.platform.common.adapter.LoyaltyProvider;
...
/**
 * Hutch Loyalty Provider — manages loyalty points and rewards for Hutch subscribers.
 *
 * <p>Implements the canonical {@link LoyaltyProvider} contract from platform-common.
 * Hutch uses API-key authentication for the BSS loyalty endpoints.</p>
 *
...
@Slf4j
@Component
@RegisterAdapter(tenantId = "hutch-lk", providerInterface = LoyaltyProvider.class)
@RequiredArgsConstructor
public class HutchLoyaltyProvider implements ApiAdapter, LoyaltyProvider {
    ...
    public PointsBalance getPointsBalance(String tenantId, String connectionId) {
        ...
        String path = "/api/v1/loyalty/" + connectionId + "/balance";
        try {
            ...
            log.error("Hutch getPointsBalance failed for tenant={} connection={}: {}",
    ...
    public TierInfo getTier(String tenantId, String connectionId) {
        ...
        String path = "/api/v1/loyalty/" + connectionId + "/tier";
        try {
            Map<String, Object> resp = httpClient.get(tenantId, cfg, path, null, null);
            if (resp == null) return null;
            Object dataObj = resp.get("data");
            ...
            log.error("Hutch getTier failed for tenant={} connection={}: {}",
                    tenantId, connectionId, e.getMessage());
            return null;
        }
    }
    ...
    public List<Reward> getAvailableRewards(String tenantId, String connectionId) {
        ...
        String path = "/api/v1/loyalty/" + connectionId + "/rewards";
        try {
            Map<String, Object> resp = httpClient.get(tenantId, cfg, path, null, null);
            ...
            log.error("Hutch getAvailableRewards failed for tenant={} connection={}: {}",
                    tenantId, connectionId, e.getMessage());
            return List.of();
        }
    }
    ...
    public RedemptionResult redeemReward(String tenantId, String connectionId, String rewardCode) {
        ...
        if (!cfg.isValid()) {
            log.warn("Hutch BSS not configured for tenant={}", tenantId);
            return new RedemptionResult(false, null, rewardCode, null, null, null, null, "No Hutch BSS integration");
        }
        ...
        try {
            Map<String, Object> resp = httpClient.post(tenantId, cfg,
                    "/api/v1/loyalty/" + connectionId + "/redeem", body, null);
            if (resp == null) {
            ...
            log.error("Hutch redeemReward failed for tenant={} connection={} reward={}: {}",
    ...
    public List<PointsTransaction> getPointsHistory(String tenantId, String connectionId, int limit) {
        ...
        String path = "/api/v1/loyalty/" + connectionId + "/transactions";
        try {
            ...
            log.error("Hutch getPointsHistory failed for tenant={} connection={}: {}",
                    tenantId, connectionId, e.getMessage());
            return List.of();
        }
    }
