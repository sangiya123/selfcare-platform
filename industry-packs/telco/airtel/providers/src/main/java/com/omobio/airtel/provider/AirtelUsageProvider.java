...
import com.omobio.platform.common.adapter.UsageProvider;
...
/**
 * Airtel Usage Provider — fetches detailed usage records from Airtel BSS.
 *
 * <p>Implements the canonical {@link UsageProvider} contract from platform-common.
 * Airtel uses API-key authentication for BSS usage endpoints and wraps responses
...
@Slf4j
@Component
@RegisterAdapter(tenantId = "airtel-lk", providerInterface = UsageProvider.class)
@RequiredArgsConstructor
public class AirtelUsageProvider implements ApiAdapter, UsageProvider {
    ...
    public List<DataUsageRecord> getDataUsage(String tenantId, String connectionId,
        ...
        String path = "/v1/osp/usage/" + connectionId + "/records";
        try {
            ...
            log.error("Airtel getDataUsage failed for tenant={} connection={}: {}",
    ...
    public List<VoiceUsageRecord> getVoiceUsage(String tenantId, String connectionId,
        ...
        try {
            ...
            log.error("Airtel getVoiceUsage failed for tenant={} connection={}: {}",
                    tenantId, connectionId, e.getMessage());
            return List.of();
        }
    }
    ...
    public List<SmsUsageRecord> getSmsUsage(String tenantId, String connectionId,
        ...
        try {
            ...
            log.error("Airtel getSmsUsage failed for tenant={} connection={}: {}",
                    tenantId, connectionId, e.getMessage());
            return List.of();
        }
    }
    ...
    public CurrentUsage getCurrentUsage(String tenantId, String connectionId) {
        ...
        String path = "/v1/osp/usage/" + connectionId + "/current";
        try {
            ...
            log.error("Airtel getCurrentUsage failed for tenant={} connection={}: {}",
                    tenantId, connectionId, e.getMessage());
            return null;
        }
    }
    ...
    public List<RoamingUsageRecord> getRoamingUsage(String tenantId, String connectionId,
        ...
        String path = "/v1/osp/usage/" + connectionId + "/roaming";
        try {
            Map<String, Object> resp = httpClient.get(tenantId, cfg, path, queryParams, null);
            if (resp == null) return List.of();
            Object dataObj = resp.get("data");
            ...
            log.error("Airtel getRoamingUsage failed for tenant={} connection={}: {}",
                    tenantId, connectionId, e.getMessage());
            return List.of();
        }
    }
