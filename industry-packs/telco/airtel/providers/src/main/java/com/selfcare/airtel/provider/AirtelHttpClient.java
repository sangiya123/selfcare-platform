...
public class AirtelHttpClient {
    ...
    /**
     * Live SSRF enforcement: every outbound request to an Airtel endpoint is
    ...
    private void enforceAllowlist(String baseUrl) {
        ...
        try {
            ...
            log.warn("Airtel outbound request blocked by SSRF allow list: {}", baseUrl);
            throw new AirtelApiException(null, AirtelApiException.AIRTEL_SEC_001,
