...
public class DialogApiException extends RuntimeException {
    ...
    public DialogApiException(HttpStatusCode statusCode, String dialogErrorCode, String message) {
        this(statusCode, dialogErrorCode, message, (Map<String, Object>) null);
    }
    ...
    // Security
    public static final String DIALOG_SEC_001 = "DIALOG-SEC-001"; // Outbound URL blocked by SSRF allow list
}
