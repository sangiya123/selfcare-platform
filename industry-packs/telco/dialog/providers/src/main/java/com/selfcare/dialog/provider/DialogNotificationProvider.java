...
/**
 * Dialog Notification Provider â€” sends SMS via Dialog SMSC.
 *
...
public class DialogNotificationProvider implements ApiAdapter, NotificationChannelProvider {
    ...
    private static final String DEFAULT_SENDER_ID = "selfcare";
    ...
    /**
     * Tenant-explicit variant â€” used by callers that already know the tenant.
     */
